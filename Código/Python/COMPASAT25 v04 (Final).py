...
ruta_directorio = "C:/Users/CMC10506/Documents/Antón/programas/Python/datos"
    ...
    if arduino.in_waiting > 0:
        try:
            ...
            if len(datos) == 9:
                ...
                ax4.clear()
                ax4.plot(num, ppm, color='purple', label='CO₂ (ppm)')
                ax4.set_title("Concentración de CO₂")
                ax4.set_ylabel("ppm")
                ax4.legend()
                ax4.grid()
...
# Configuración del puerto serie. IMPORTANTE CAMBIAR EL COM
try:
    arduino = serial.Serial('COM4', 9600, timeout=1)
    time.sleep(2)  # Espera a que el puerto se inicialice
    print("Conectado con éxito al puerto COM4")
    ...
    with open(nombre_archivo, 'a') as file:
        ...
        plt.tight_layout()
        plt.subplots_adjust(hspace=0.5) # Usar si las gráficas quedan muy juntas
        plt.show()
